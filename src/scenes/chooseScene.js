var ChooseScene = function(game, stage)
{
  ...
  self.ready = function()
  {
    ...
    btn_orient_game = new ButtonBox(10,130,dc.width/2-15,30,function(evt){ game.start = 3; game.setScene(3); });
  ...
  self.draw = function()
  {
    ...
    btn_orient_game.draw(dc); dc.context.fillStyle = "#000000"; dc.context.fillText("Orient Game",btn_orient_game.x+8,btn_orient_game.y+btn_orient_game.h-4);
  };
