var ChooseScene = function(game, stage)
{
  ...
  self.ready = function()
  {
    ...
    btn_real_game   = new ButtonBox(10, 50,dc.width/2-15,30,function(evt){ game.start = 1; game.setScene(3); });
    //btn_find_game   = new ButtonBox(10,130,dc.width/2-15,30,function(evt){ game.start = 2; game.setScene(3); });
    //btn_time_game   = new ButtonBox(10,170,dc.width/2-15,30,function(evt){ game.start = 3; game.setScene(3); });
    //btn_orient_game = new ButtonBox(10, 90,dc.width/2-15,30,function(evt){ game.start = 4; game.setScene(3); });
    //btn_secret_game = new ButtonBox(10,210,dc.width/2-15,30,function(evt){ game.start = 5; game.setScene(3); });
